...
export const configGen = (version) => {
    ...
    return `deb https://mirrors.idc.daocloud.io/raspbian/raspbian/ ${release_name} main non-free contrib rpi
# deb-src https://mirrors.idc.daocloud.io/raspbian/raspbian/ ${release_name} main non-free contrib rpi
deb [arch=arm64] https://mirrors.idc.daocloud.io/raspbian/multiarch/ ${release_name} main
`;
}
