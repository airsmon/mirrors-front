...
**注：该镜像是 Homebrew / Linuxbrew 源程序以及 formula / cask 索引的镜像（即 `brew update` 时所更新内容）。镜像站同时提供相应的二进制预编译包的镜像（[Homebrew bottles](https://mirrors.idc.daocloud.io/homebrew-bottles)） **
...
```bash
export HOMEBREW_API_DOMAIN="https://mirrors.idc.daocloud.io/homebrew-bottles/api"
export HOMEBREW_BOTTLE_DOMAIN="https://mirrors.idc.daocloud.io/homebrew-bottles"
export HOMEBREW_PIP_INDEX_URL="https://mirrors.idc.daocloud.io/pypi/web/simple/"
```
...
```bash
export HOMEBREW_BREW_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/brew.git"
export HOMEBREW_CORE_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git"
...
git clone --depth=1 https://mirrors.idc.daocloud.io/git/homebrew/install.git brew-install
...
# 请按需执行如下两行命令：
brew tap --custom-remote --force-auto-update homebrew/core https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git
brew tap --custom-remote --force-auto-update homebrew/cask https://mirrors.idc.daocloud.io/git/homebrew/homebrew-cask.git
# 除 homebrew/core 和 homebrew/cask 仓库外的 tap 仓库仍然需要设置镜像
brew tap --custom-remote --force-auto-update homebrew/cask-fonts https://mirrors.idc.daocloud.io/git/homebrew/homebrew-cask-fonts.git
brew tap --custom-remote --force-auto-update homebrew/cask-drivers https://mirrors.idc.daocloud.io/git/homebrew/homebrew-cask-drivers.git
brew tap --custom-remote --force-auto-update homebrew/cask-versions https://mirrors.idc.daocloud.io/git/homebrew/homebrew-cask-versions.git
brew tap --custom-remote --force-auto-update homebrew/command-not-found https://mirrors.idc.daocloud.io/git/homebrew/homebrew-command-not-found.git
brew update
# 或使用下面的几行命令自动设置
export HOMEBREW_CORE_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git"
for tap in core cask{,-fonts,-drivers,-versions} command-not-found; do
    brew tap --custom-remote --force-auto-update "homebrew/${tap}" "https://mirrors.idc.daocloud.io/git/homebrew/homebrew-${tap}.git"
done
brew update
```
...
```bash
test -r ~/.bash_profile && echo 'export HOMEBREW_BREW_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/brew.git"' >> ~/.bash_profile  # bash
test -r ~/.bash_profile && echo 'export HOMEBREW_CORE_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git"' >> ~/.bash_profile
test -r ~/.profile && echo 'export HOMEBREW_BREW_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/brew.git"' >> ~/.profile
test -r ~/.profile && echo 'export HOMEBREW_CORE_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git"' >> ~/.profile
test -r ~/.zprofile && echo 'export HOMEBREW_BREW_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/brew.git"' >> ~/.zprofile  # zsh
test -r ~/.zprofile && echo 'export HOMEBREW_CORE_GIT_REMOTE="https://mirrors.idc.daocloud.io/git/homebrew/homebrew-core.git"' >> ~/.zprofile
```
