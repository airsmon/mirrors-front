...
```conf
GENTOO_MIRRORS="https://mirrors.idc.daocloud.io/gentoo"
```
...
```bash
export GENTOO_MIRRORS="https://mirrors.idc.daocloud.io/gentoo"
export SNAPSHOT_URL="https://mirrors.idc.daocloud.io/gentoo/snapshots"
# export GNU_URL="http://mirrors.idc.daocloud.io/gnu"
```
