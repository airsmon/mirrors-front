...
cpan[2]> o conf urllist unshift https://mirrors.idc.daocloud.io/CPAN/

# 或将本站镜像加入镜像列表末尾
# 注：本命令和上面的命令执行一个即可，修改列表不会执行自动去重
cpan[3]> o conf urllist push https://mirrors.idc.daocloud.io/CPAN/

# 或清空镜像列表，仅保留本站
cpan[4]> o conf urllist https://mirrors.idc.daocloud.io/CPAN/
...
if ! (
    ...
    grep -qF 'https://mirrors.idc.daocloud.io/CPAN/'
); then
    perl -MCPAN -e 'CPAN::HandleConfig->load();' \
        -e 'CPAN::HandleConfig->edit("urllist", "unshift", "https://mirrors.idc.daocloud.io/CPAN/");' \
