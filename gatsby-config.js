...
module.exports = {
  siteMetadata: {
    title: 'DaoCloud Mirror',
    siteUrl: config.siteUrl,
    description: 'DaoCloud Mirror is a non-profit program aimed at popularizing open source software and facilitating efficient access to various resources of open source projects by all users.',
    author: 'DaoCloud',
  },
  ...
  developMiddleware: app => {
    app.use(
      ...
      createProxyMiddleware({
        target: 'http://mirrors.idc.daocloud.io',
        onProxyReq: (proxyRes, req, res) => {
          proxyRes.setHeader('host', 'mirrors.idc.daocloud.io');
        },
      }),
    );
  }
